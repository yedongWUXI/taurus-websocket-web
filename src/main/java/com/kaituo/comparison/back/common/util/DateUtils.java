...
public class DateUtils {
    ...
    public final static String DATE_TIME_HOURS_MIN_SECOND = "yyyyMMddHHmmss";
    ...
    public static String formatTimeTo14(Date date) {
        return format(date, DATE_TIME_HOURS_MIN_SECOND);
    }
